...
\begin{xltabular}{\textwidth}{|l|X|}
    ...
    \textbf{Preconditions} &
        ...
        \\ \hline
    \textbf{Postconditions} &
        - Supporting documents (e.g., CV, motivation letter, recommendations) are uploaded and linked to the student’s applications. \newline
        - Coordinator and companies (where applicable) can access documents during seriation and evaluation.
        \\ \hline
    \textbf{Main Flow} &
        1. Student opens the “My Applications / Rankings” page. \newline
        2. System indicates which applications or editions require supporting documents. \newline
        3. Student selects an application requiring documents. \newline
        ...
        6. System validates file types and sizes, stores them securely, and links them to the corresponding application. \newline
        7. System shows a confirmation and updates the application status to “Documents Submitted”. \\ \hline
    \textbf{Alternative Flows} &
        ...
        1. Before the document deadline, student returns to the application. \newline
...
\renewcommand{\arraystretch}{1.5} 
\begin{xltabular}{\textwidth}{|l|X|}
    \caption{Use Case Specification: Coordinator Performs Superuser Access for Student Support} \label{tab:UC-12} \\
    
    \hline
    \textbf{Use Case ID} & UC-11 \\ \hline
    \textbf{Use Case Name} & Coordinator Performs Superuser Access for Student Support \\ \hline
    \textbf{Primary Actor} & Edition Coordinator \\ \hline
    \textbf{Secondary Actors} & Student, Coordinator, Company Representative, System \\ \hline
    \textbf{Preconditions} &
        - Edition Coordinator is authenticated. \newline
    ...
    \textbf{Postconditions} &
        ...
        \\ \hline
    \textbf{Main Flow} &
        1. Coordinator opens the “Support / Superuser Access” area. \newline
        2. System lists open support tickets or allows searching by user, edition, or proposal. \newline
        3. Coordinator selects a case and views context (user roles, assignments, logs). \newline
        4. Based on the case the Coordinator logs in the Superuser with the other user's login. \newline
        5. Coordinator troubleshoots the problems. \newline
    ...
    \textbf{Alternative Flows} &
        ...
        3. Coordinator records this outcome in the ticket. \newline
        \textbf{A2. Impersonation session ended:} \newline
        1. During impersonation, administrator finishes troubleshooting. \newline
        2. Coordinator exits superuser session explicitly. \newline
        3. System returns to the coordinator's own account and logs the full session. \\ \hline
\end{xltabular}
