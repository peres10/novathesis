...
\begin{xltabular}{\textwidth}{|l|X|}
    \caption{Use Case Specification: Proposal Ranking and Submission} \label{tab:UC-01} \\
    ...
    \textbf{Preconditions} &
        ...
        - Proposal ranking period is open (not before start date, not after deadline). \newline
...
\begin{xltabular}{\textwidth}{|l|X|}
    ...
    \textbf{Secondary Actors} & Company Representative, System, Email Service \\ \hline
    \textbf{Preconditions} &
    ...
    \textbf{Postconditions} &
        ...
        - Company Representative is notified via email and in-app notification. \newline
    ...
    \textbf{Main Flow} &
        ...
        9. System sends email to Company Representative with feedback details [FR-53]. \newline
        10. System posts in-app notification to Company dashboard [FR-54]. \newline
    ...
    \textbf{Alternative Flows} &
        ...
        4. Company is notified of approval via email and in-app notification. \newline
        ...
        3. Company is notified with rejection reason via email [FR-53]. \newline
        4. Proposal is not visible to students \newline
        \textbf{A3. Company fails to respond to clarification request within deadline:} \newline
...
\begin{xltabular}{\textwidth}{|l|X|}
    ...
    \textbf{Secondary Actors} & Edition Coordinator, Student, Company \\ \hline
    \textbf{Preconditions} &
    ...
    \textbf{Postconditions} &
        ...
        - Companies receive the list of students assigned for each of their proposals \newline
    ...
    \textbf{Main Flow} &
        ...
        8. System sends email notifications to all companies with their ranked candidate lists [FR-35] \newline
    ...
    \textbf{Alternative Flows} &
        \textbf{Algorithm detects data inconsistency (e.g., student has invalid Average Grade)} \newline
...
\renewcommand{\arraystretch}{1.5} 
\begin{xltabular}{\textwidth}{|l|X|}
    \caption{Use Case Specification: Company Responds to Coordinator Feedback and Resubmits Proposal} \label{tab:UC-04} \\
    
    \hline
    \textbf{Use Case ID} & UC-04 \\ \hline
    \textbf{Use Case Name} & Company Responds to Coordinator Feedback and Resubmits Proposal \\ \hline
    \textbf{Primary Actor} & Company Representative \\ \hline
    \textbf{Secondary Actors} & Edition Coordinator, System \\ \hline
    \textbf{Preconditions} &
        - Coordinator has requested clarification on company's proposal [UC-02, A3]. \newline
        - Company has not yet exceeded the response deadline. \newline
        - Company Representative is logged in.
        \\ \hline
    \textbf{Postconditions} &
        ...
        \\ \hline
    \textbf{Main Flow} &
        1. Company Representative receives email notification of requested clarification. \newline
        2. Representative logs in to the platform and navigates to "My Proposals". \newline
        3. System displays the proposal marked "Awaiting Clarification" with coordinator's feedback highlighted. \newline
        4. Representative reviews feedback and modifies proposal details (e.g., clarifies location, adds requirements). \newline
        5. Representative adds a response comment addressing each point of feedback. \newline
        6. Representative clicks "Resubmit Proposal". \newline
        ...
        10. Audit log records: resubmission timestamp, modification details, company response comment [FR-63]. \\ \hline
    \textbf{Alternative Flows} &
        \textbf{A1. Company does not respond before the deadline:} \newline
        ...
        \textbf{A2. Company's modifications do not resolve the coordinator's concerns:} \newline
...
\renewcommand{\arraystretch}{1.5} 
\begin{xltabular}{\textwidth}{|l|X|}
    \caption{Use Case Specification: Company Views Assigned Candidates List and Schedules Interviews} \label{tab:UC-08} \\
    
    \hline
    \textbf{Use Case ID} & UC-08 \\ \hline
    \textbf{Use Case Name} & Company Views Assigned Candidates List and Schedules Interviews \\ \hline
    \textbf{Primary Actor} & Company Representative \\ \hline
    \textbf{Secondary Actors} & Coordinator, System \\ \hline
    \textbf{Preconditions} &
        - Seriation for the relevant edition has been executed successfully. \newline
        - Company has at least one accepted proposal in that edition. \newline
        - Representative is authenticated and linked to that company.
        \\ \hline
    \textbf{Postconditions} &
        - Representative can see ranked or assigned candidates per proposal.
        \\ \hline
    \textbf{Main Flow} &
        1. Representative logs in and navigates to “My Proposals / Candidates”. \newline
        2. System lists the company’s proposals for the edition and their current seriation status. \newline
        3. Representative selects a proposal. \newline
        4. System displays the ranked candidate list or assigned students, including basic profile data allowed by policy. \newline
        5. Representative optionally selects one or more candidates get their contacts to schedule interview outside the platform. \\ \hline
    \textbf{Alternative Flows} &
        \textbf{A1. No candidates available:} \newline
        1. At step 4, system indicates that no candidates were ranked for that proposal. \newline
        2. Representative may close the view or contact the coordinator outside this use case. \\ \hline
\end{xltabular}
...
\renewcommand{\arraystretch}{1.5} 
\begin{xltabular}{\textwidth}{|l|X|}
    \caption{Use Case Specification: Professor Proposes Dissertation Theme} \label{tab:UC-09} \\
    
    \hline
    \textbf{Use Case ID} & UC-09 \\ \hline
    \textbf{Use Case Name} & Professor Proposes Dissertation Theme \\ \hline
    \textbf{Primary Actor} & Professor \\ \hline
    \textbf{Secondary Actors} & Coordinator, System \\ \hline
    \textbf{Preconditions} &
        - A Master’s dissertation edition is open for receiving internal proposals. \newline
        - Professor is authenticated and has permission to submit themes.
        \\ \hline
    \textbf{Postconditions} &
        - A new dissertation theme is stored with status “Submitted” or “Pending Validation”. \newline
        - Coordinator can review and publish the theme to students.
        \\ \hline
    \textbf{Main Flow} &
        1. Professor logs in and accesses “Dissertation Themes / New Theme”. \newline
        2. System shows a form for theme details (title, abstract, objectives, prerequisites, research area, expected outcomes). \newline
        3. Professor fills in details, selects the relevant edition, and optionally co-supervisors. \newline
        4. Professor submits the theme. \newline
        5. System validates required fields and stores the theme. \newline
        6. Theme appears in the coordinator’s validation queue. \\ \hline
    \textbf{Alternative Flows} &
        \textbf{A1. Edition closed:} \newline
        1. At step 3, if the dissertation edition is not accepting themes, system blocks submission. \newline
        2. System informs the professor and shows allowed submission periods. \newline
        \textbf{A2. Draft saving:} \newline
        1. Before submitting, professor chooses “Save as Draft”. \newline
        2. System saves a draft that is not yet visible to coordinators or students. \newline
        3. Professor can later edit the draft and submit it. \\ \hline
\end{xltabular}
...
\renewcommand{\arraystretch}{1.5} 
\begin{xltabular}{\textwidth}{|l|X|}
    \caption{Use Case Specification: Secretariat Verifies Payment and Finalizes Protocol} \label{tab:UC-10} \\
...
\renewcommand{\arraystretch}{1.5} 
\begin{xltabular}{\textwidth}{|l|X|}
    \caption{Use Case Specification: Edition Coordinator Publishes Call for Proposals} \label{tab:UC-11} \\
...
\begin{xltabular}{\textwidth}{|l|X|}
    ...
    \textbf{Main Flow} &
        ...
        4. Administrator chooses an appropriate superuser action (e.g., impersonate user session, correct role, adjust a single record). \newline
        5. System prompts for a mandatory justification note. \newline
        6. Administrator confirms the action. \newline
        7. System executes the action, logs all details (who, what, when, why), and informs the affected user via notification. \\ \hline
    \textbf{Alternative Flows} &
...
%% UC-03: System Executes Student Seriation Algorithm 
%% UC-04: Company Responds to Coordinator Feedback and Resubmits Proposal 
%% UC-05: Edition Coordinator Creates New Edition 
%% UC-06: Company Representatives Registers and Submits Initial Proposal 
%% UC-07: Student Submits Support Documentation
%% UC-08: Company Views Assigned Candidates List and Schedule Interviews
%% UC-09: Professor Proposes Dissertation Theme 
%% UC-10: Secretariat Verifies Payment and Finalizes Protocol -
%% UC-11: Edition Coordinator Publishes Call for Proposals 
%% UC-12: Administrator Performs Superuser Access for Student Support 