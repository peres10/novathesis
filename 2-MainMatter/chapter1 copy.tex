...
\includegraphics[width=0.1\linewidth]{\gls{novathesis}Files/Images/novathesis-insignia}\hfill
\includegraphics[width=0.875\linewidth]{\gls{novathesis}Files/Images/novathesis-text}
...
\section{The \emph{\gls{novathesis}} Template}
...
\caption{\gls{novathesis} template in Overleaf.}
\label{fig:overleaf}
\end{wrapfigure}
...
\caption{The \gls{novathesis} Project page in GitHub.}
\label{fig:github2}
\end{wrapfigure}
