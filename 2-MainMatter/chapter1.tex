...
\section{Methodology}
  ...
  \begin{enumerate}
    ...
    \item{
      ...
      The initial implementation phase will leverage \textit{Vibe Coding} tools, such as Lovable, 
      Figma Make or Google AI Studio, to quickly generate the frontend and core functional 
      interfaces \cite{vibecoding2025}. 
