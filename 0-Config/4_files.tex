...
\ntaddfile{chapter}{chap2}
\ntaddfile{chapter}{chap3}
\ntaddfile{chapter}{chap4}
...
\ntaddfile{appendix}{appendix_fr_nfr}
\ntaddfile{appendix}{appendix_use_cases}
\ntaddfile{appendix}{appendix_bpmn}
\ntaddfile{appendix}{appendix_erd}
...
% \ntaddfile{annex}{annex2}
%\ntaddfile{annex}{annex_fr_nfr}
%\ntaddfile{annex}{annex_use_cases}
